...
export default {
  setup() {
    ...
    onMounted(() => {
$('.zoom').zoom({url: '/image/lab/mm_mobile_bg.jpeg'});
...
<template>
  <div 
  ref="bg"
  class="overflow-hidden relative h-screen w-full flex justify-center">
    <!--  -->
    ...
    <!--  -->
<!--     <div 
    class="overflow-x-auto overflow-y-hidden sm:overflow-overflow relative bg-black mm-ratio min-h-screen min-w-[100vw] absolute hidden lg:flex"> -->
    <div 
    class="overflow-x-auto overflow-y-hidden sm:overflow-overflow relative bg-black mm-ratio min-h-screen min-w-[100vw] absolute zoom">
